...
# predict the target from all the input features
       ...
       st.write("Developed By: Gaston Costa")
       st.markdown("""[Linkedin](https://www.linkedin.com/in/gastoncosta/) |
       [Kaggle](https://www.kaggle.com/gastoncostagonzalz) 
       """)
...
st.markdown("Please find GitHub repository link of project: [Click Here](https://github.com/gagc056/gagc056-streamlit)")          
